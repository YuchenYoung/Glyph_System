<template>
  <div style="text-align: center">
    ...
    <ul v-show="svg_display">
      <li v-for="item in svg_list" :key="item" v-html="item" :style="svg_size"></li>
    </ul>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    separateSvgComponents(src) {
      ...
      _this.svg_size.width = head.split(`width="`)[1].split(`"`)[0] + "px";
      _this.svg_size.height = head.split(`height="`)[1].split(`"`)[0] + "px";
